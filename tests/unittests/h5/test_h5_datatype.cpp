...
TEST_F(TestH5DataType, template_defaultDataTypes) // somewhat redundant
{
    ...
    EXPECT_EQ(GenH5::dataType<char[5]>().size(), 5 * sizeof(char));

    EXPECT_TRUE(GenH5::dataType<int8_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<int8_t>().isInt());
    EXPECT_TRUE(GenH5::dataType<int8_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<int8_t>().size(), sizeof(int8_t));
    EXPECT_TRUE(GenH5::dataType<int16_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<int16_t>().isInt());
    EXPECT_TRUE(GenH5::dataType<int16_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<int16_t>().size(), sizeof(int16_t));
    EXPECT_TRUE(GenH5::dataType<int32_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<int32_t>().isInt());
    EXPECT_TRUE(GenH5::dataType<int32_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<int32_t>().size(), sizeof(int32_t));
    EXPECT_TRUE(GenH5::dataType<int64_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<int64_t>().isInt());
    EXPECT_TRUE(GenH5::dataType<int64_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<int64_t>().size(), sizeof(int64_t));

    EXPECT_TRUE(GenH5::dataType<uint8_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<uint8_t>().isInt());
    EXPECT_FALSE(GenH5::dataType<uint8_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<uint8_t>().size(), sizeof(uint8_t));
    EXPECT_TRUE(GenH5::dataType<uint16_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<uint16_t>().isInt());
    EXPECT_FALSE(GenH5::dataType<uint16_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<uint16_t>().size(), sizeof(uint16_t));
    EXPECT_TRUE(GenH5::dataType<uint32_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<uint32_t>().isInt());
    EXPECT_FALSE(GenH5::dataType<uint32_t>().isSigned());
    EXPECT_EQ(GenH5::dataType<uint32_t>().size(), sizeof(uint32_t));
    EXPECT_TRUE(GenH5::dataType<uint64_t>().isValid());
    EXPECT_TRUE(GenH5::dataType<uint64_t>().isInt());
    ...
    EXPECT_EQ(GenH5::dataType<signed char>().size(), sizeof(signed char));
    EXPECT_TRUE(GenH5::dataType<signed short>().isValid());
    EXPECT_TRUE(GenH5::dataType<signed short>().isInt());
    EXPECT_TRUE(GenH5::dataType<signed short>().isSigned());
    EXPECT_EQ(GenH5::dataType<signed short>().size(), sizeof(signed short));
    EXPECT_TRUE(GenH5::dataType<signed int>().isValid());
    EXPECT_TRUE(GenH5::dataType<signed int>().isInt());
    EXPECT_TRUE(GenH5::dataType<signed int>().isSigned());
    EXPECT_EQ(GenH5::dataType<signed int>().size(), sizeof(signed int));
    EXPECT_TRUE(GenH5::dataType<signed long int>().isValid());
    EXPECT_TRUE(GenH5::dataType<signed long int>().isInt());
    EXPECT_TRUE(GenH5::dataType<signed long int>().isSigned());
    EXPECT_EQ(GenH5::dataType<signed long int>().size(), sizeof(signed long int));
    EXPECT_TRUE(GenH5::dataType<signed long long int>().isValid());
    EXPECT_TRUE(GenH5::dataType<signed long long int>().isInt());
    EXPECT_TRUE(GenH5::dataType<signed long long int>().isSigned());
    EXPECT_EQ(GenH5::dataType<signed long long int>().size(), sizeof(signed long long int));

    EXPECT_TRUE(GenH5::dataType<unsigned char>().isValid());
    EXPECT_TRUE(GenH5::dataType<unsigned char>().isInt());
    EXPECT_FALSE(GenH5::dataType<unsigned char>().isSigned());
    EXPECT_EQ(GenH5::dataType<unsigned char>().size(), sizeof(unsigned char));
    EXPECT_TRUE(GenH5::dataType<unsigned short>().isValid());
    EXPECT_TRUE(GenH5::dataType<unsigned short>().isInt());
    EXPECT_FALSE(GenH5::dataType<unsigned short>().isSigned());
    EXPECT_EQ(GenH5::dataType<unsigned short>().size(), sizeof(unsigned short));
    EXPECT_TRUE(GenH5::dataType<unsigned int>().isValid());
    EXPECT_TRUE(GenH5::dataType<unsigned int>().isInt());
    EXPECT_FALSE(GenH5::dataType<unsigned int>().isSigned());
    EXPECT_EQ(GenH5::dataType<unsigned int>().size(), sizeof(unsigned int));
    EXPECT_TRUE(GenH5::dataType<unsigned long int>().isValid());
    EXPECT_TRUE(GenH5::dataType<unsigned long int>().isInt());
    EXPECT_FALSE(GenH5::dataType<unsigned long int>().isSigned());
    EXPECT_EQ(GenH5::dataType<unsigned long int>().size(), sizeof(unsigned long int));
    EXPECT_TRUE(GenH5::dataType<unsigned long long int>().isValid());
    EXPECT_TRUE(GenH5::dataType<unsigned long long int>().isInt());
    EXPECT_FALSE(GenH5::dataType<unsigned long long int>().isSigned());
    EXPECT_EQ(GenH5::dataType<unsigned long long int>().size(), sizeof(unsigned long long int));
...
TEST_F(TestH5DataType, string)
{
    constexpr bool isUtf8 = true;
    constexpr size_t size = 5;
    EXPECT_TRUE(GenH5::DataType::varString(isUtf8).isUtf8());
    EXPECT_FALSE(GenH5::DataType::varString(!isUtf8).isUtf8());
    EXPECT_TRUE(GenH5::DataType::varString(isUtf8).isVarString());
    EXPECT_TRUE(GenH5::DataType::varString(!isUtf8).isVarString());

    EXPECT_TRUE(GenH5::DataType::string(size, isUtf8).isUtf8());
    EXPECT_FALSE(GenH5::DataType::string(size, !isUtf8).isUtf8());
    EXPECT_FALSE(GenH5::DataType::string(size, isUtf8).isVarString());
    EXPECT_FALSE(GenH5::DataType::string(size, !isUtf8).isVarString());
    EXPECT_EQ(GenH5::DataType::string(size, isUtf8).size(), size);
    EXPECT_EQ(GenH5::DataType::string(size, !isUtf8).size(), size);
}
...
TEST_F(TestH5DataType, template_arrayDataTypes)
{
    ...
    EXPECT_TRUE(dataType<ArrayT2>().type() == DataTypeClass::String);
    ...
    EXPECT_TRUE(dataType<ArrayT3>().superType().type() == DataTypeClass::String);
    ...
    EXPECT_TRUE(dataType<ArrayT4>().superType().type() == DataTypeClass::Float);
}
...
TEST_F(TestH5DataType, template_complexDataTypes)
{
    ...
    EXPECT_TRUE(arrayType.isArray());
    EXPECT_EQ(arrayType.size(), 42 * sizeof (GenH5::varlen_t));
